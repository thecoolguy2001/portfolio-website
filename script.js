...
const projectData = {
    ...
    coralgala: {
        ...
        problem: "Despite the popularity of ambient apps and screensavers, most virtual fish tanks are static, single-user, or tied to outdated software. There's a gap in fun, lightweight web-based experiences that users can visit casually and still return to often.",
    ...
    quicker: {
        title: "QuickER",
        subtitle: "UI/UX Mockup",
        role: "UI/UX Designer / Mobile App Developer",
        timeline: "February 12, 2023 → July 31, 2023",
        tools: "Figma, Flutter",
    ...
    familyduel: {
        ...
        summary: "Family Duel is a living-room party game for Apple TV, where two teams face off on the big screen, buzzing in from their own phones to answer survey-style questions before the clock runs out. Built for game night, not a single player alone on a couch.",
    ...
    safebrowsing: {
        ...
        timeline: "May 2, 2023 → May 20, 2023",
    ...
    packtrack: {
        ...
        solution: "Pack Track works two ways. Manual mode keeps the list in packages.txt on the SD card, with no backend at all. Live mode uses a Wi-Fi devboard running FlipperHTTP plus your own tracking-service API key: no provider is hardcoded, so a config file points it at any service, and pressing RIGHT refreshes every package.",
